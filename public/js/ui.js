...
import { handleConnectedUserHangedUp } from "./webRTCHandler.js";
...
export const updateUIAfterHangUp = (callType) => {
  ...
  // Check if callType is valid before using it
  ...
  } else if (callType === constants.callType.CHAT_PERSONAL_CODE ||
  ...
  //hide remote video and show placeholder
  console.log('hide remote video and show placeholder');
  const remoteVideo = document.getElementById('remote_video');
  hideElement(remoteVideo);
